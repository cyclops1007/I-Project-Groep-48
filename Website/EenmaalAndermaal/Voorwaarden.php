...
<div id="text-container" class="container rounded col-sm-6">
    ...
    <p>Alle intellectuele eigendomsrechten, waaronder mede begrepen de
        ...
        opgenomen met toestemming van de betreffende eigenaar.</p>

    <p>U mag een gedeelte van de website printen of downloaden naar een
    ...
    <p>Het is zonder onze voorafgaande schriftelijke toestemming dus, onder
        meer, verboden om:</p>
    ...
    <p>Wij hebben de inhoud van deze website met de grootst mogelijke zorg
        ...
        zal werken en/of vrij zal zijn van fouten.</p>

    <p>Als er op de website wordt verwezen naar producten of diensten, is
        dat geen aanbod voor de verkoop of levering van dat product of die
        dienst.</p>

    <p>Voor zover wettelijk toegestaan sluit Unilever, waaronder mede
        ...
        wijze ontstaat door en/of voortvloeit uit:</p>
    <ul>
        ...
        <li>het feit dat bepaalde informatie op de website onjuist,
            onvolledig of niet actueel is.</li>
    </ul>

    <h2>Aan de site gekoppelde sites (gelinkte sites)</h2>

    <p>De website kan verwijzingen (bijvoorbeeld door middel van een
        ...
        voor deze andere sites inclusief de daarin opgenomen informatie.</p>

    <p>Door u verstrekte informatie en materiaal</p>

    <p>Indien u informatie of ander materiaal aan ons verstrekt, gaat u
    ...
    <p>Op bepaalde onderdelen van de website kunnen de gebruikers zelf
    ...
    <p>Indien u op de website persoonsgegevens aan ons verstrekt, zoals uw
    ...
    <p>Indien u een vraag of klacht heeft over deze website neem dan
        contact met ons op via het contactformulier</p>

    <h2>Diversen</h2>

    <p>Wij behouden ons het recht voor, zonder voorafgaande kennisgeving op
